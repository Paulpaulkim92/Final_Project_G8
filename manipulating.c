...
void manipulating() {
	...
	// 	/* Version 3 */
	// 	/*The program allows the user to search for a substring (needle) within a larger string (haystack) and returns the position of the first occurrence of the substring. It continues to process inputs until the user enters "q" to quit.*/
